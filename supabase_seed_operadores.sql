...
(gen_random_uuid()::text, 'EDEQ', 'Edeq', true, '{"tipo_archivo": "xlsx", "hoja": 0, "fila_inicio": 2, "separador_csv": ",", "columnas": {"codigo_frontera": "CODIGO SIC", "nombre_frontera": "DESCRIPCIÓN CLIENTE", "energia_kwh": "Energía Activa", "valor_cop": "Valor Activa", "periodo": null, "nivel_tension": "Nivel de Tensión  de la Frontera", "propiedad_activos": "Propiedad", "energia_reactiva_ind_pen": "Energía Reactiva Inductiva Penalizada", "energia_reactiva_cap_pen": "Energía Reactiva Capacitiva Penalizada", "valor_reactiva_cop": "Valor Reactiva Inductiva Penalizada", "factor_m": "Factor M (Energia Reactiva )"}}'::jsonb, NULL, now(), now()),
-- EEP_CARTAGO: validado con archivo
(gen_random_uuid()::text, 'EEP_CARTAGO', 'EEP Cartago', true, '{"tipo_archivo": "xlsx", "hoja": 0, "fila_inicio": 3, "separador_csv": ",", "columnas": {"codigo_frontera": "SIC", "nombre_frontera": "Cliente", "energia_kwh": "Energía Activa ", "valor_cop": "Valor $ Activa", "tarifa_sdl": "Tarifa Activa", "periodo": null, "nivel_tension": "Nivel Tension", "propiedad_activos": null, "energia_reactiva_ind_pen": "Energía Reactiva Inductiva", "energia_reactiva_cap_pen": "Energía Reactiva Capacitiva", "valor_reactiva_cop": "Valor $ Reactiva Inductiva", "tarifa_reactiva": "Tarifa Reactiva", "factor_m": "Factor M"}}'::jsonb, NULL, now(), now()),
...
-- EPM: activa validada (preprocessor preEpm). Reactiva pendiente. Multi-archivo via accion "agregar".
(gen_random_uuid()::text, 'EPM', 'EPM', true, '{"tipo_archivo": "xlsx", "hoja": 0, "fila_inicio": 14, "separador_csv": ",", "columnas": {"codigo_frontera": "Código SIC", "nombre_frontera": "Instalación", "energia_kwh": "ENERGÍA Activa SDL (KW)", "valor_cop": "INGRESO Activa SDL($)", "tarifa_sdl": "Cargo por Uso($/KWh)", "periodo": null, "nivel_tension": "Nivel de Tensión", "propiedad_activos": null, "energia_reactiva_ind_pen": null, "energia_reactiva_cap_pen": null, "valor_reactiva_cop": null, "tarifa_reactiva": null, "factor_m": null}}'::jsonb, NULL, now(), now()),
-- ESSA: validado con archivo
(gen_random_uuid()::text, 'ESSA', 'ESSA', true, '{"tipo_archivo": "xlsx", "hoja": 0, "fila_inicio": 5, "separador_csv": ",", "columnas": {"codigo_frontera": "CODIGO SIC", "energia_kwh": "DEFINITIVO", "valor_cop": "PEAJE ACTIVA", "tarifa_sdl": "TARIFA ACTIVA", "periodo": null, "nivel_tension": "NIVEL TENSION", "propiedad_activos": "PROPIEDAD", "energia_reactiva_ind_pen": "REACTIVA PENALIZADA", "energia_reactiva_cap_pen": "CAPACITIVA PENALIZADA", "valor_reactiva_cop": "PEAJE INDUCTIVA", "tarifa_reactiva": "TARIFA REACTIVA", "factor_m": "M DIC"}}'::jsonb, NULL, now(), now()),
-- RUITOQUE: validado con archivo
(gen_random_uuid()::text, 'RUITOQUE', 'Ruitoque', true, '{"tipo_archivo": "xlsx", "hoja": 0, "fila_inicio": 7, "separador_csv": ",", "columnas": {"codigo_frontera": "Código SIC", "energia_kwh": "Activa", "valor_cop": "Valor Activa", "tarifa_sdl": "Tarifa Activa", "periodo": null, "nivel_tension": "NT", "propiedad_activos": null, "energia_reactiva_ind_pen": "R_Inductiva Penalizada", "energia_reactiva_cap_pen": "R_Capacitiva Penalizada", "valor_reactiva_cop": "Valor R_Inductiva", "tarifa_reactiva": "Tarifa Reactiva", "factor_m": "Factor M"}}'::jsonb, NULL, now(), now())
